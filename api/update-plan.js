  ...
  try {
    ...
    const metaRes = await fetch(shopifyUrl, {
      ...
      body: JSON.stringify({
        ...
        variables: {
          metafields: [
            { ownerId: customerGid, namespace: 'custom', key: 'plan_1', value: planNombre, type: 'single_line_text_field' },
            { ownerId: customerGid, namespace: 'custom', key: 'plan_2', value: 'gid://shopify/Metaobject/' + planId, type: 'metaobject_reference' }
          ]
        }
      })
    });
